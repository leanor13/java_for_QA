...
public class ContactCreationTest {
  ...
  private void login(LoginData loginData) {
    ...
    wd.findElement(By.name("user")).sendKeys(loginData.getLogin());
  ...
  public void testContactCreation() {
    initAddContact();
    fillContactForm(new ContactData("NameTest1", "LastNameTest", "testtest", "test", "CompTets", "Address test test", "5849395", "+93927298403", "95040843", "ttt@kmkmk.tt"));
